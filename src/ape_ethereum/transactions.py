...
class Receipt(ReceiptAPI):
    ...
    @cached_property
    def _call_tree(self) -> CallTreeNode:
    ...
    def get_gas_usage(self):
        gas_cost = self._call_tree.gas_cost
        return gas_cost
